...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center pt-24 lg:pt-32">
        <motion.div
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-poppins font-extrabold leading-tight mb-6 text-white">
        ...
        >
          <div className="relative w-[450px] h-[450px] rounded-full overflow-hidden shadow-2xl border-4 border-roma-gold/30 rotate-3 hover:rotate-0 transition-transform duration-700">
