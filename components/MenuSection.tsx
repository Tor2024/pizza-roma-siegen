...
const menuData: { pizzas: MenuItem[]; pasta: MenuItem[]; salads: MenuItem[]; drinks: MenuItem[]; desserts: MenuItem[] } = {
  pizzas: [
        {
          id: 'p1',
          image: '/images/p1_pizza_margherita.webp',
        ...
        {
          id: 'p2',
          image: '/images/p2_pizza_salami.webp',
        ...
        {
          id: 'p3',
          image: '/images/p3_pizza_tonno.webp',
        ...
        {
          id: 'p4',
          image: '/images/p4_pizza_diavola.webp',
        ...
        {
          id: 'p5',
          image: '/images/p5_pizza_quattro.webp',
        ...
        {
          id: 'p6',
          image: '/images/p6_pizza_prosciutto.webp',
          ...
          allergensDesc: { de: 'Gluten, Milch', ru: 'Глютен, Молоко' }
        }
  ],
  pasta: [
        {
          id: 'pas1',
          image: '/images/pas1_pasta_carb.webp',
        ...
        {
          id: 'pas2',
          image: '/images/pas2_pasta_bolo.webp',
  ...
  salads: [
        {
          id: 's1',
          image: '/images/s1_salad_caesar.webp',
        ...
        {
          id: 's2',
          image: '/images/s2_salad_mista.webp',
          ...
          allergens: ['Milch', 'Fisch'],
          allergensDesc: { de: 'Milch, Fisch', ru: 'Молоко, Рыба' }
        },
        {
          id: 's3',
          image: '/images/s3_salad_tomate.webp',
  ...
  drinks: [
        ...
        {
          id: 'd4',
          image: '/images/d4_Mineralwasser_0_5L.webp',
        ...
        {
          id: 'd5',
          image: '/images/d5_Bier_0_5L.webp',
  ...
  desserts: [
        {
          id: 'de1',
          image: '/images/de1_dessert_tiramisu.webp',
        ...
        {
          id: 'de2',
          image: '/images/de2_dessert_panna.webp',
        ...
        {
          id: 'de3',
          image: '/images/de3_dessert_ice.webp',
      ...
      <div className="container mx-auto px-4">
        ...
        {Object.entries(filteredCategories).map(([key, category]: [string, any], index) => (
          <div key={key} id={`cat-${key}`}>
            <h3 className={`text-3xl font-poppins font-bold text-roma-dark mt-8 mb-8 border-l-4 ${categoryColors[key] || 'border-gray-500'} pl-4`}>
